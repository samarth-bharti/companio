...
const BENEFITS = [
  ...
  },
  {
    ...
    body: `Set your own rate. Paid bookings are not open yet — the first meetups are the one included in a member's pass — so treat this as early access, not income. When paid bookings open, you keep ${COMPANION_SHARE_PCT}% of your rate and we pay it to your UPI id.`,
    color: "#7A4FE0",
    bg: "#F0EBFF",
  },
  {
